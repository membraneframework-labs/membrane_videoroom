...
export const isLoading = (track: TrackWithId | null) => track !== null && track?.stream === undefined && track?.metadata?.active === true;
export const showDisabledIcon = (track: TrackWithId | null) => track !== null && track?.stream === undefined || track?.metadata?.active === false;
