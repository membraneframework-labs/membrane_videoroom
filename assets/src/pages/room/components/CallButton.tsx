...
const CallButton = ({ webrtc }: { webrtc: WebRTCEndpoint | undefined }) => {
    ...
    return (
        <>
            <button
                id="phone-call"
                className={inCall ? redButtonStyle : neutralButtonStyle}
                onClick={handleButtonClick}
            >
                {inCall ? <><HangUpPhone /> Hangup phone </> : <><PhoneCall /> Call phone</>}
            </button>
            ...
            >
                ...
                />
                <button style={customButtonStyles} onClick={handleSubmit}>Submit</button>
